...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Infomaniak/android-authenticator", .upToNextMajor(from: "0.0.2")),
        .package(url: "https://github.com/Infomaniak/ios-core", .upToNextMajor(from: "18.11.0")),
