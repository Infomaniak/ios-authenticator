...
public struct AuthenticatorTrailingLabel: View {
    ...
    private init(title: String, icon: Image? = nil, iconColor: Color? = nil) {
        self.title = title
        self.icon = icon
    ...
    public init(
        _ title: String,
        iconKey: KeyPath<AuthenticatorResourcesAsset.Images.Type, AuthenticatorResourcesImages>? = nil,
        iconColor: Color? = nil
    ) {
        let icon = iconKey != nil ? AuthenticatorResourcesAsset.Images.self[keyPath: iconKey!].swiftUIImage : nil
